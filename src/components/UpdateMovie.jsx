...
const UpdateMovie = ({ UpdateMovies }) => {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row md:flex-row justify-center items-center p-6 space-y-6 lg:space-y-0 lg:space-x-6">
        <div className="w-[282px] h-[340px] bg-gray-100 flex flex-col items-center justify-center">
          <input
            type="file"
            accept="image/*"
          ...
          <img
            ...
            alt={name}
            className="w-full h-full shadow-lg lg:mb-0 cursor-pointer"
        ...
        <div className="p-6">
          ...
          <form onSubmit={UpdatingMovies}>
              ...
              <div className="flex items-center justify-center space-x-20">
                <div className="flex items-center">
                  <input
                    ...
                    name="type"
                    value="movie"
                    className="mr-2 radio-button accent-indigo-500"
                    checked={type === "movie"}
            ...
            <button
              type="submit"
              className="w-full bg-indigo-500 text-white py-2 px-4 rounded-3xl hover:bg-indigo-900"
            >
              Update Movie
            </button>
          </form>
